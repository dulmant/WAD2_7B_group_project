# Generated by Django 2.2.28 on 2023-03-10 13:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.PositiveSmallIntegerField(choices=[(1, 'quiz taker'), (2, 'quiz maker')], default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quiz_maker', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quiz_author', to=settings.AUTH_USER_MODEL)),
                ('quiz_taker', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
